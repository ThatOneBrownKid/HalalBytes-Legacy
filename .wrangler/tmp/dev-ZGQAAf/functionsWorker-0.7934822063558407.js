...
// .wrangler/tmp/bundle-Bt1kOU/checked-fetch.js
...
// .wrangler/tmp/pages-TinWtE/functionsWorker-0.7934822063558407.mjs
...
var REVIEW_SYSTEM_PROMPT = `You are a content moderator for a restaurant review site.
...
var IMAGE_ONLY_SYSTEM_PROMPT = `You are an image content moderator for a restaurant review site.
...
var AVATAR_SYSTEM_PROMPT = `You are an image content moderator for user avatars.
...
var createErrorResponse = /* @__PURE__ */ __name2((reason, status, corsHeaders) => {
  return new Response(
    JSON.stringify({ success: false, error: { reason } }),
    { status, headers: { ...corsHeaders, "Content-Type": "application/json" } }
  );
}, "createErrorResponse");
var createSuccessResponse = /* @__PURE__ */ __name2((data, corsHeaders) => {
  return new Response(
...
var onRequestPost = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    const { reviewText, imageBase64, moderationType = "review" } = await context.request.json();
...
// .wrangler/tmp/bundle-Bt1kOU/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Bt1kOU/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7934822063558407.js.map
