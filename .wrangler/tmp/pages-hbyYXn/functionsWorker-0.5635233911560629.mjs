...
// ../.wrangler/tmp/bundle-TZudkq/checked-fetch.js
...
var createErrorResponse = /* @__PURE__ */ __name((reason, status, corsHeaders) => {
  return new Response(
    JSON.stringify({ success: false, error: { reason } }),
    { status, headers: { ...corsHeaders, "Content-Type": "application/json" } }
  );
}, "createErrorResponse");
var createSuccessResponse = /* @__PURE__ */ __name((data, corsHeaders) => {
  return new Response(
...
// ../.wrangler/tmp/pages-hbyYXn/functionsRoutes-0.5345842689610294.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-TZudkq/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-TZudkq/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5635233911560629.mjs.map
